...
function Sidebar(props) {
  ...
  return (
    <Navbar
      className="navbar-vertical fixed-left bg-gradient-dark  text-white"
      expand="md"
      id="sidenav-main"
    >
      <Container fluid>
        ...
        >
            ...
            <img style={{width:"40px",height:"40px",backgroundColor:"none"}} src={toggler} />      
        ...
        {/* User */}
        <Nav className="align-items-center bg-dark  text-white d-md-none">
          <UncontrolledDropdown nav>
            ...
            <DropdownMenu
              ...
              right
            >
              <DropdownItem>See Notifications</DropdownItem>
